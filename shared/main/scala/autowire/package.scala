...
package object autowire {
  ...
  case class ClientProxy[Trait, PickleType, ReadBound[_], WriteBound[_], ClientType <: Client[PickleType, ReadBound, WriteBound]](self: ClientType)

  @compileTimeOnly("unwrapClientProxy should not exist at runtime!")
  implicit def unwrapClientProxy[Trait, PickleType, ReadBound[_], WriteBound[_], ClientType <: Client[PickleType, ReadBound, WriteBound]](w: ClientProxy[Trait, PickleType, ReadBound, WriteBound, ClientType]): Trait = ???

  trait ReadWrite[PickleType, ReadBound[_], WriteBound[_]]{
    def read[Result: ReadBound](p: PickleType): Result
    def write[Result: WriteBound](r: Result): PickleType
  }
  /**
   ...
   */
  trait Client[PickleType, ReadBound[_], WriteBound[_]] extends ReadWrite[PickleType, ReadBound, WriteBound]{
     ...
     *               against.
     */
    def apply[Trait] = ClientProxy[Trait, PickleType, ReadBound, WriteBound, this.type](this)
  ...
  trait Server[PickleType, ReadBound[_], WriteBound[_]] extends ReadWrite[PickleType, ReadBound, WriteBound]{
    type Request = autowire.Request[PickleType]
